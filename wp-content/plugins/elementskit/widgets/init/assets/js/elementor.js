! function(e, t) {
    ...
    var i = {
        ...
        Social_Review_Slider: function(t) {
            t.each((function() {
                let t = `\n\t\t\t\t\t<button type="button" class="slick-prev slick-arrow">\n\t\t\t\t\t\t<i class="${e(this).data("prevarrow")?e(this).data("prevarrow"):"icon icon-left-arrow2"}"></i>\n\t\t\t\t\t</button>\n\t\t\t\t`,
                    ...
                    n = !(!e(this).data("autoplay") || "yes" !== e(this).data("autoplay")),
                    a = {
                        autoplay: n,
                        ...
                        infinite: "undefined" === e(this).data("autoplay") || n,
                        breakpoints: "[]" !== e(this).data("responsive") ? e(this).data("responsive") : [],
                        loop: "yes" == e(this).data("carousel_loop")
                    };
                a.arrows && (e(this).append(t + i), a.navigation = {
                    prevEl: e(this).find(".slick-prev"),
                    nextEl: e(this).find(".slick-next")
                }), a.dots && (a.pagination = {
                    el: e(this).find(".swiper-pagination"),
                    type: "custom",
                    clickable: !0,
                    renderCustom: (e, t, i) => {
                        var n = "";
                ...
                let s = new Swiper(e(this).find(".swiper-container"), a);
                n && a.pauseOnHover && e(this).find(".swiper-container").hover((function() {
                    s.autoplay.stop()
                }), (function() {
                    s.autoplay.start()
                }))
        ...
        Advanced_Tab: function(t) {
            ...
            ElementsKit_Helper.triggerClickOnEvent(a, n), n.on("shown.bs.tab", (function() {
                let n = t.find(e(this)).data("target").substring(1),
                    a = t.find(`#${n}`);
                i.WidgetAreaJSUpdate.call(a), ElementsKit_Helper.setURLHash(s, this, "ekit-handler-id"), ElementsKit_Helper.ajaxLoading(t, a)
            })).filter(".active").trigger("shown.bs.tab")
        },
        Gallery: function(t) {
        ...
        Woo_Product_slider: function(e) {
            let t = e.find(".ekit-swiper-container"),
                i = t.data("autoplay"),
                n = t.data("loop"),
                a = t.data("speed"),
                s = t.data("space-between"),
                o = t.data("responsive-settings");
            new Swiper(t, {
                navigation: {
                    nextEl: e.find(".ekit-navigation-next"),
                    prevEl: e.find(".ekit-navigation-prev")
                },
                pagination: {
                    el: e.find(".ekit-swiper-pagination"),
                    type: "bullets",
                    clickable: !0
                },
                autoplay: i && i,
                loop: n && Boolean(n),
                speed: a && Number(a),
                slidesPerView: Number(o.ekit_columns_mobile),
                ...
                breakpoints: {
                    ...
                    768: {
                        slidesPerView: Number(o.ekit_columns_tablet),
                        spaceBetween: s && Number(s)
                    },
                    1024: {
                        slidesPerView: Number(o.ekit_columns_desktop),
                        spaceBetween: s && Number(s)
                    }
                }
            })
        ...
        Video_Gallery: function(t) {
            var i = t.find(".video-link.popup"),
                n = t.find(".video-link.inline"),
                a = (t.find(".ekit-video-gallery-wrapper.ekit-masonry"), t.find(".elementskit-main-filter>li>a")),
                s = t.find(".ekit-video-gallery.ekit-carousel"),
                o = s.data("config");
            i.length > 0 && i.magnificPopup({
                ...
                t.find("a").removeClass("selected"), e(this).addClass("selected"), t.find(".ekit-video-item").hide(), t.find(".ekit-video-item" + n).fadeIn()
            })), s.length && (o.arrows && (o.navigation = {
                prevEl: t.find(".slick-prev"),
                nextEl: t.find(".slick-next")
            }), o.dots && (o.pagination = {
            ...
            }), new Swiper(t.find(".swiper-container"), o)), jQuery(".ekit-video-gallery.ekit-masonry").isotope({
                percentPosition: !0,
        ...
        BlogPosts: function(t) {
            var i = t.find(".ekit-blog-post-pagination-container"),
                n = t.data("id"),
                a = {
                    items: "#post-items--" + n,
                    nagivation: "#post-nagivation--" + n
                };
            if (t.on("click", ".ekit-blog-post-pagination-container a.page-numbers", (function(n) {
                    n.preventDefault();
                    ...
                    e.ajax({
                        ...
                        var s = e(n),
                            o = s.find(a.items).html(),
                            l = s.find(a.nagivation).html();
                        "loadmore" == i.data("ekit-blog-post-style") ? t.find(a.items).append(o) : t.find(a.items).html(o), t.find(a.nagivation).html(l)
                    }))
                })), "yes" === t.find(a.items).data("enable")) {
                let e = t.find(".blogCarousel"),
                    i = e.data("settings");
                if ("undefined" != typeof Swiper) {
                    const n = {
                        spaceBetween: i.spaceBetween,
                        slidesPerView: i.slidesPerView,
                        slidesPerGroup: i.slidesPerGroup,
                        loop: !0,
                        speed: i.speed,
                        breakpoints: i.breakPoints
                    };
                    !0 === i.navigation && (n.navigation = {
                        nextEl: t.find(".ekit-blog-carousel-button-next"),
                        prevEl: t.find(".ekit-blog-carousel-button-prev")
                    }), !0 === i.pagination && (n.pagination = {
                        el: t.find(".ekit-blog-carousel-pagination"),
                        clickable: !0
                    }), !0 === i.autoplay && (n.autoplay = {
                        delay: i.autoplayDelay
                    }, !0 === i.pauseOnHover && t.find(".swiper-container").hover((function() {
        ...
        Advanced_Slider: function(t) {
            let i = t.find(".ekit-slider-wrapper"),
                n = t.closest(".swiper-custom-nav"),
                a = t.find(".ekit-progress-bar"),
                s = t.find(".elementskit-advanced-slider").data("widget_settings");
            if ("undefined" != typeof Swiper) {
                var o = {
                    loop: !0,
                    speed: 600,
                    ...
                    pagination: {
                        el: i.find(".swiper-pagination.ekit-swiper-pagination"),
                        clickable: !0
                    },
                    on: {
                        init: function() {
                    ...
                    navigation: {
                        nextEl: n.length ? n.find(".ekit-double-btn-two") : t.find(".swiper-button-next"),
                        prevEl: n.length ? n.find(".ekit-double-btn-one") : t.find(".swiper-button-prev")
                    }
                };

                function l(e) {
                    a.addClass("progress-bar-active"), e.update()
                }

                function r(e) {
                    a.removeClass("progress-bar-active"), e.update()
                }

                function d(t) {
                    let i = t.activeIndex;
                    e(t.slides[i]).find(".elementor-widget").each((function(t, i) {
                        let n = e(i).data("settings") ? ? [];
                        if (n.hasOwnProperty("_animation") && n._animation) {
                            let t = n.hasOwnProperty("_animation_delay") ? n._animation_delay : 1200;
                            e(i).css({
                                "animation-name": "unset"
                            }), setTimeout((() => {
                                e(i).css({
                                    "animation-name": n._animation
                                }), e(i).hasClass("elementor-invisible") && (e(i).removeClass("elementor-invisible"), e(i).addClass("animated"))
                            }), t), e(i).hasClass("elementor-invisible") || (e(i).addClass("elementor-invisible"), e(i).addClass("animated"))
                        }
                    })), t.update()
                }

                function c(t) {
                    i.find(".ekit-swiper-slide").css({
                        height: "auto"
                    });
                    let n = t.activeIndex,
                        a = e(t.slides[n]).height();
                    i.find(".ekit-swiper-wrapper, .ekit-swiper-slide").css({
                        height: a
                    }), t.update()
                }
                if ("horizontal" == s.sliderOptions.sliderDirectionType ? (o.slidesPerView = s.sliderOptions.slidesPerViewItem, o.spaceBetween = s.sliderOptions.spaceBetweenGap, o.breakpoints = s.sliderOptions.breakpointsOption) : o.slidesPerView = 1, "yes" != s.sliderOptions.sliderAutoPlay && "yes" != s.sliderOptions.progressBar || (o.autoplay = {
                        delay: s.sliderOptions.autoPlayDelay ? s.sliderOptions.autoPlayDelay : 3e3,
                        pauseOnMouseEnter: !0
                    }, t.find(".ekit-slider-wrapper").hover((function() {
                        this.swiper.autoplay.stop()
                    }), (function() {
                        this.swiper.autoplay.start()
                    }))), "yes" == s.sliderOptions.sliderMouseScroll && (o.mousewheel = {
                        invert: !0,
                        releaseOnEdges: !0,
                        sensitivity: 1,
                        thresholdTime: 10
                    }), new Swiper(i, o), "yes" == s.sliderOptions.progressBar && (t.find(".ekit-slider-wrapper, .ekit-swiper-progress").each((function(t, i) {
                        e(i).on("mouseenter", (function() {
                            a.css({
                                animationPlayState: "paused"
                            })
                        }))
                    })), t.find(".ekit-slider-wrapper, .ekit-swiper-progress").each((function(t, i) {
                    ...
                    function p() {
                        let t = s.sliderOptions.sliderTabItems.map((e => e.ekit_slider_thumbs_image.url)),
                            n = 0;
                        i.find(".ekit-swiper-pagination > .swiper-pagination-bullet").each((function() {
                            e(this).css({
                                background: "url(" + t[n] + ")",
                    ...
                    e(i).each((function() {
                        var e = i.find(".ekit-swiper-pagination > .swiper-pagination-bullet").siblings().css({
                            width: "100%"
                        });
                        "horizontal" == s.sliderOptions.sliderDirectionType ? (i.find(".swiper-pagination.ekit-swiper-pagination").css({
                            width: s.sliderOptions.sliderThumbsOffset.size ? s.sliderOptions.sliderThumbsOffset.size + "%" : "70%",
                            display: "grid",
                            gridTemplateColumns: "repeat(" + e.length + ",1fr)",
                            gridTemplateRows: "1fr",
                            marginTop: "7px"
                        }), i.addClass("slider-thumbs-yes")) : (i.find(".swiper-pagination.ekit-swiper-pagination").css({
                            display: "grid",
                            gridTemplateColumns: "1fr",
                            gridTemplateRows: "repeat(" + e.length + ",1fr)"
                        }), i.addClass("slider-thumbs-yes"))
                    })), p()
                }
            }
        },
        ...
        Fancy_Animated_Text: function(i) {
            let n = i.data("settings");
            if (t.isEditMode() && (n = t.config.elements.data[i.data("model-cid")].attributes), "animated" === n.ekit_fancy_animation_style) {
                var a = n.ekit_fancy_animation_delay ? n.ekit_fancy_animation_delay : 2500,
                    s = n.ekit_fancy_loading_bar ? n.ekit_fancy_loading_bar : 3800,
                    o = s - 3e3,
                    l = n.ekit_fancy_letters_delay ? n.ekit_fancy_letters_delay : 50,
                    r = n.ekit_fancy_type_letters_delay ? n.ekit_fancy_type_letters_delay : 150,
                    d = n.ekit_fancy_selection_duration ? n.ekit_fancy_selection_duration : 500,
                    c = d + 800,
                    p = n.ekit_fancy_reveal_duration ? n.ekit_fancy_reveal_duration : 600,
                    f = n.ekit_fancy_reveal_animation_delay ? n.ekit_fancy_reveal_animation_delay : 1500;

                function u() {
                    var t, n;
                    i.find(".ekit-fancy-text.letters").find("b").each((function() {
                        var t = e(this),
                            i = t.text().split(""),
                        ...
                        var a = i.join("");
                        t.html(a)
                    })), t = i.find(".ekit-fancy-text"), n = a, t.each((function() {
                        var t = e(this);
                        if (t.hasClass("bar-loading")) n = s, setTimeout((function() {
                ...
                function h(e) {
                    ...
                    if (e.parents(".ekit-fancy-text").hasClass("type")) {
                        ...
                        w(e, t), k(e.find("i").eq(0), e, n, l), g(t.find("i").eq(0), t, n, l)
                    } else e.parents(".ekit-fancy-text").hasClass("clip") ? e.parents(".ekit-fancy-text-lists").animate({
                        width: "2px"
                    }, p, (function() {
                        w(e, t), m(t)
                    })) : e.parents(".ekit-fancy-text").hasClass("bar-loading") ? (e.parents(".ekit-fancy-text-lists").removeClass("is-loading"), w(e, t), setTimeout((function() {
                        h(t)
                    }), s), setTimeout((function() {
                        e.parents(".ekit-fancy-text-lists").addClass("is-loading")
                    }), o)) : (w(e, t), setTimeout((function() {
                        h(t)
                    }), a))
                }
        ...
        Price_Menu: function(e) {
            var t = e.find(".swiper-container"),
                i = t.find(".swiper-wrapper").data("config");
            i != undefined && (i.pagination = {
                el: e.find(".swiper-pagination"),
                clickable: !0
            }, i.navigation = {
                nextEl: e.find(".ekit-price-card-slider-button-next"),
                prevEl: e.find(".ekit-price-card-slider-button-prev")
            }, i.autoplay && i.pauseOnHover && e.find(".swiper-container").hover((function() {
                this.swiper.autoplay.stop()
            }), (function() {
                this.swiper.autoplay.start()
            }))), new Swiper(t, i)
        },
        Google_Review: function(t) {
            let i = t.find(".swiper-container"),
                n = i.find(".swiper-wrapper").data("config");
            if (n != undefined && (n.pagination = {
                    el: t.find(".swiper-pagination"),
                    clickable: !0
                }, n.navigation = {
                    nextEl: t.find(".ekit-google-review-slider-button-next"),
                    prevEl: t.find(".ekit-google-review-slider-button-prev")
                }, n.autoplay && n.pauseOnHover && t.find(".swiper-container").hover((function() {
                    this.swiper.autoplay.stop()
                }), (function() {
                    this.swiper.autoplay.start()
                }))), new Swiper(i, n), t.find(".ekit-google-review").length > 0) {
                const {
                    textLimit: i,
                    moreText: n,
                    lessText: a
                } = t.find(".ekit-google-review").data("settings");
                "yes" == i && t.find(".ekit-show-more-less").on("click", (function() {
                    e(this).siblings(".ekit-hidden-text").toggle(), e(this).siblings(".ekit-dot").toggle(), e(this).text((function(e, t) {
                        return t === n ? a : n
                    }))
                }))
            }
        ...
        Team_Slider: function(e) {
            var t = e.find(".ekit-team-popup"),
                i = e.find(".swiper-container").data("config");
            t.magnificPopup({
                type: "inline",
                fixedContentPos: !0,
                fixedBgPos: !0,
                ...
                nextEl: e.find(".ekit-team-slider-button-next"),
                prevEl: e.find(".ekit-team-slider-button-prev")
            }, i.autoplay && i.pauseOnHover && e.find(".swiper-container").hover((function() {
                this.swiper.autoplay.stop()
            }), (function() {
                this.swiper.autoplay.start()
            }))), new Swiper(e.find(".swiper-container"), i)
        },
        ...
        Content_Ticker: function(t) {
            let i = t.find(".ekit-content-ticker-wrapper"),
                n = t.find(".ekitMarqueeSwiper"),
                a = i.data("content-settings"),
                s = a.settingOptions.tickerEffect;
            if ("undefined" != typeof Swiper && "marquee" !== s) {
                var o = {
                    loop: !0,
                    speed: a.settingOptions.tickerSpeed ? "typing" === s ? 100 : 1e3 * a.settingOptions.tickerSpeed : 1e3,
                    slidesPerView: "auto",
                    direction: a.settingOptions.tickerDirection ? a.settingOptions.tickerDirection : "horizontal",
                    effect: s ? "typing" === s ? "fade" : s : "slide",
                    fadeEffect: {
                        crossFade: !0
                    },
                    grabCursor: "yes" == a.settingOptions.tickerGrabCursor,
                    allowTouchMove: "yes" == a.settingOptions.tickerGrabCursor,
                    navigation: {
                        nextEl: t.find(".ekit-marquee-button-next"),
                        prevEl: t.find(".ekit-marquee-button-prev")
                    },
                    on: {
                        init: function() {
                            l(this)
                ...
                function l(e) {
                    if ("vertical" === a.settingOptions.tickerDirection) {
                        i.find(".ekit-marquee-item").css({
                            height: "auto"
                        });
                        let t = e.activeIndex,
                            n = e.slides[t].scrollHeight;
                        i.find(".ekit-marquee .swiper-wrapper, .ekit-marquee-item").css("height", `${n}px`), e.update()
                    }
                }
                ...
                function r(t) {
                    if ("typing" === s) {
                        ...
                        let o = 0;
                        ! function l() {
                            o < s.length && (n[0].innerHTML += s.charAt(o), o++, setTimeout(l, (a.settingOptions.tickerDelay - 3e3) / s.length))
                        }()
                    }
                }
                "yes" === a.settingOptions.tickerAutoPlay && (o.autoplay = {
                    delay: a.settingOptions.tickerDelay ? a.settingOptions.tickerDelay : 700,
                    reverseDirection: "yes" === a.settingOptions.tickerReverseDirection,
                    disableOnInteraction: !1
                }, n.hover((function() {
                    this.swiper.autoplay.stop(), n.find(".swiper-wrapper").css({
                        "animation-play-state": "paused"
                    })
                }), (function() {
                    this.swiper.autoplay.start(), n.find(".swiper-wrapper").css({
            ...
            if ("marquee" === s) {
                let d = t.find(".ticker"),
                    c = t.find(".marquee-wrapper"),
                    p = c.clone(!0);
                "yes" === a.settingOptions.tickerReverseDirection ? d.addClass("ticker-right") : d.addClass("ticker-left"), d.css({
                    "padding-left": "100%"
                }), c.css({
                    "padding-right": "100%"
                }), "yes" !== a.settingOptions.tickerGapBetween && (d.append(p), "yes" === a.settingOptions.tickerReverseDirection ? d.addClass("ticker-right-loop") : d.addClass("ticker-left-loop"), d.css({
                    "padding-left": "unset",
                    display: "flex"
                }), c.css({
                    "padding-right": "unset"
